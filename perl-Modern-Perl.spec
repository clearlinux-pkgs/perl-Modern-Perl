...
%prep
%setup -q -n Modern-Perl-1.20241001
cd %{_builddir}/Modern-Perl-1.20241001
pushd ..
cp -a Modern-Perl-1.20241001 buildavx2
popd
...
cp %{_builddir}/Modern-Perl-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Modern-Perl/efdc320ad29a840b4e14075329a77d03a8b7c027 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Modern-Perl/efdc320ad29a840b4e14075329a77d03a8b7c027
