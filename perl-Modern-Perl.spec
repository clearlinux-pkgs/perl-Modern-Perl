...
Source0  : https://cpan.metacpan.org/authors/id/C/CH/CHROMATIC/Modern-Perl-1.20220515.tar.gz
...
%prep
%setup -q -n Modern-Perl-1.20220515
cd %{_builddir}/Modern-Perl-1.20220515
...
cp %{_builddir}/Modern-Perl-1.20220515/LICENSE %{buildroot}/usr/share/package-licenses/perl-Modern-Perl/e4b87ee67b79a6af319bd3182902d79c3d318714
if test -f Makefile.PL; then
