...
Version  : 1.20240115
Release  : 35
URL      : https://cpan.metacpan.org/authors/id/C/CH/CHROMATIC/Modern-Perl-1.20240115.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/C/CH/CHROMATIC/Modern-Perl-1.20240115.tar.gz
...
%prep
%setup -q -n Modern-Perl-1.20240115
cd %{_builddir}/Modern-Perl-1.20240115
pushd ..
cp -a Modern-Perl-1.20240115 buildavx2
popd
...
cp %{_builddir}/Modern-Perl-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Modern-Perl/022794c7dd0ad42d2c219f92e16e68ca5bb0a804 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Modern-Perl/022794c7dd0ad42d2c219f92e16e68ca5bb0a804
